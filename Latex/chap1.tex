...
\begin{figure}
    \centering
     ...
     \begin{subfigure}[b]{0.3\textwidth}
        ...
        \label{intro 2}
     \end{subfigure}
    \caption{(a) Two CFTs at thermal equilibrium separated with a static interface. Time flows upwards. (b) The holographic dual of the two CFTs featuring a domain wall in the bulk separating the two geometries.}
